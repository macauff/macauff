...
def test_naive_bayes_match(x, y):
    ...
    generate_random_data(n_a, n_b, n_c,
                         extent + np.array([1.1*r/3600, -1.1*r/3600, 1.1*r/3600, -1.1*r/3600]), n_a_filts,
                         n_b_filts, a_astro_sig, b_astro_sig, a_cat, b_cat, seed=9999)
